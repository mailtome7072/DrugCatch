...
- `.claude/skills/writing-plans.md` 파일을 읽고 계획 작성 형식과 방법론을 파악합니다.
- 스킬에 명시된 구조와 형식을 스프린트 계획 작성에 적용합니다.

### 3단계: 스프린트 계획 수립
사용자 요구사항과 ROADMAP의 맥락을 결합하여 다음을 포함한 계획을 수립합니다:
...
- `docs/sprint/sprint{N}/` 하위 디렉토리도 함께 생성합니다. (sprint-close agent가 스크린샷 등 첨부 파일을 이 경로에 저장합니다.)
